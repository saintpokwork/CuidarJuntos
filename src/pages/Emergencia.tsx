...
import { emergencySheet, emergencyContacts } from '../data/mockData';
    ...
    <DashboardLayout>
      <main className="flex-1 w-full relative pb-24 lg:pb-8">
        ...
        <div className="max-w-[1200px] mx-auto px-container-padding-mobile md:px-container-padding-desktop py-stack-lg">
          <section className="flex flex-wrap gap-3 mb-stack-lg">
            <button
              type="button"
            ...
            <div className="md:col-span-8 space-y-gutter">
              <div className="emergency-gradient p-gutter rounded-[24px] text-on-primary shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-headline-lg font-headline-lg mb-4">{emergencySheet.nome}</h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <p className="text-label-sm opacity-80">Data de nascimento</p>
                      <p className="text-body-lg font-bold">{emergencySheet.dataNascimento}</p>
                    </div>
                    <div>
                      <p className="text-label-sm opacity-80">Número SNS</p>
                      <p className="text-body-lg font-bold">{emergencySheet.numeroSNS}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card rounded-[24px] p-6 soft-shadow border border-white/40">
                ...
                <ul className="space-y-2">
                  {emergencySheet.medicamentosAtuais.map((med) => (
              ...
              <div className="glass-card rounded-[24px] p-6 soft-shadow border border-white/40">
                ...
                <p className="text-body-md text-on-surface-variant leading-relaxed">
                  {emergencySheet.notasImportantes}
                </p>
              </div>
            </div>
              ...
              <div className="glass-card rounded-[24px] p-6 soft-shadow border border-white/40">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-label-md font-bold text-on-surface">{emergencySheet.medicoFamilia}</p>
                  </div>
                  <div>
                    <p className="text-label-sm text-on-surface-variant">Farmácia habitual</p>
                    <p className="text-label-md font-bold text-on-surface">{emergencySheet.farmaciaHabitual}</p>
                  </div>
                  <div>
                    <p className="text-label-sm text-on-surface-variant">Morada</p>
                    <p className="text-label-md font-bold text-on-surface">{emergencySheet.morada}</p>
                  </div>
                </div>
              </div>
